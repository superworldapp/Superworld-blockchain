...
import "https://github.com/kole-swapnil/openzepkole/token/ERC20/ERC20.sol";
...
//@params: takes in a stringToBytes32
//@returns: returns nothing, creates a new bytes object from the string
...
//@params: takes in one address of a payer and the amount they are paying
//@returns: gives a boolean, true if the transaction was approved
